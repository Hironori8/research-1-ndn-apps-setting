...
#include "src/ndnSIM/apps/ndn-consumer.hpp"
#include "src/ndnSIM/apps/ndn-consumer-cbr.hpp"
 ...
 */
class CustomConsumer : public ConsumerCbr {
public:
  static TypeId
  GetTypeId();
  ...
  virtual void
  VerificationAttack(int user_num);
